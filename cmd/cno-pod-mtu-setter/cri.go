...
func getRuntimeClient() (cri.RuntimeServiceClient, *grpc.ClientConn, error) {
...
func forEveryPodWithClient(client cri.RuntimeServiceClient, do func(pod *podStatus) error) error {
...
func forEveryPod(do func(pod *podStatus) error) error {
	...
	return forEveryPodWithClient(client, do)
}
